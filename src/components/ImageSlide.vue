<template>
  <div class="image-slide" @mousedown.prevent="startDrag"
    @touchstart="startDrag" @mouseup="endDrag" @mouseleave.prevent="endDrag"
    @touchend="endDrag">
    <div class="wrapper" ref="wrapper" @mousemove.prevent="onDrag"
      @touchmove="onDrag">
